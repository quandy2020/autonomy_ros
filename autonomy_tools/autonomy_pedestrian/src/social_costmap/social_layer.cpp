...
namespace nav2_social_costmap_plugin
{
  ...
  void SocialLayer::onInitialize()
  {
    ...
    ppl_sub_ = nod->create_subscription<pedsim_msgs::msg::People>(
  ...
  void SocialLayer::peopleCallback(
      const pedsim_msgs::msg::People::SharedPtr msg)
  {
                                 ...
                                 double *max_y)
  {
    ...
    {
      pedsim_msgs::msg::Person &person = people_list_.people[i];
      pedsim_msgs::msg::Person tpt;
    ...
    std::list<pedsim_msgs::msg::Person>::iterator p_it;

    for (p_it = transformed_people_.begin(); p_it != transformed_people_.end();
         ++p_it)
    {
      pedsim_msgs::msg::Person person = *p_it;
