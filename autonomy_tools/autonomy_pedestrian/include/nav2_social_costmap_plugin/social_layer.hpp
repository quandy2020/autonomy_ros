...
#include "pedsim_msgs/msg/people.hpp"
#include "pedsim_msgs/msg/person.hpp"
...
namespace nav2_social_costmap_plugin
{
  ...
  private:
    ...
    void peopleCallback(const pedsim_msgs::msg::People::SharedPtr msg);

    std::mutex ppl_message_mutex_;
    rclcpp::Subscription<pedsim_msgs::msg::People>::SharedPtr ppl_sub_;
    ...
    pedsim_msgs::msg::People people_list_;
    std::list<pedsim_msgs::msg::Person> transformed_people_;
